...
for DEPLOYMENT in iviaconfig iviawrprp1 iviaruntime iviadsc iviaop iviadc; do
    STATUS=`kubectl rollout status deployment $DEPLOYMENT --timeout=1s`
...
export IVIA_MGMT_BASE_URL=https://lmi.iamlab.ibm.com
