...
{{- $params := . -}}
{{- $root := first $params -}}
{{- printf "%s-iviadsc-%s" $root.Release.Name (index $params 1) | trunc 63 | trimSuffix "-" -}}
{{- end -}}
...
{{- $params := . -}}
{{- $root := first $params -}}
{{- printf "iviadsc-%s" (index $params 1) | trunc 15 | trimSuffix "-" -}}
{{- end -}}

{{- define "dsc.replica.service.name" -}}
{{- $params := . -}}
{{- $root := first $params -}}
{{- printf "iviadscrep-%s" (index $params 1) | trunc 15 | trimSuffix "-" -}}
{{- end -}}
